...
public class TableTest extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DefaultTableModel myModel = (DefaultTableModel)jXTable1.getModel();
        Vector rawData = new Vector();
        
        rawData.add(jTextField1.getText());
        rawData.add(jTextField2.getText());
        rawData.add(jTextField3.getText());
        rawData.add(jTextField4.getText());
    ...
    private void jXTable1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jXTable1MouseReleased
        ...
        {
            String name = myModel.getValueAt(jXTable1.getSelectedRow(), 2).toString();
